...
export default function Home() {
  return (
    ...
    <div className="flex justify-center flex-col gap-4 text-white items-center h-[44vh]  px-5 md:px-0 text-xs md:text-base">
      <div className="md:text-5xl flex gap-2 md:gap-20 font-bold justify-center items-center text-3xl">Buy Me a Chai <span><img className="invertImg" src="/chai.gif" width="88" alt="" /></span></div>
  ...
  <iframe
    ...
    src="https://www.youtube.com/embed/QtaorVNAwbI?si=uhmCHZjzCA21FaOc"
